...
if uploaded_file:
    ...
    # Filter for Half Hourly records
    ...
    if hh_df.empty:
        ...
        # Contract Duration Dropdown (single-select)
        ...
        # Map selection to boolean for Green_Energy
        energy_flag = True if selected_energy.lower() == "green" else False

        # Filter by contract duration and energy type
        filtered_df = hh_df[
