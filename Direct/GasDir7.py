...
This version uses a static **Clean_PostCode.csv** for postcode-to-LDZ lookup with improved outcode handling.
""")
    ...
    if tariff_df is not None:
        ...
        for site in site_data:
            if site["mprn"] != "" and site["postcode"] != "":
                ...
                outcode = cleaned[:-3]  # take everything except inward code
